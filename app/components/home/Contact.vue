    ...
    <div class="container relative">
                ...
                <div class="grid md:grid-cols-6 md:gap-4 lg:grid-cols-12 lg:gap-6">
                  <div class="md:col-span-3 mb-5 lg:col-span-6">
                    <div class="text-start">
                      ...
                      <div class="form-icon relative mt-2">
                        <Icon name="ph:user" class="w-4 h-4 absolute top-3 start-4" />
                  ...
                  <div class="md:col-span-3 mb-5 lg:col-span-6">
                    <div class="text-start">
                      ...
                      <div class="form-icon relative mt-2">
                        <Icon name="ph:phone" class="w-4 h-4 absolute top-3 start-4" />
                  ...
                  <div class="md:col-span-3 mb-5 lg:col-span-6">
                    <div class="text-start">
                      ...
                      <div class="form-icon relative mt-2">
                        <Icon name="ph:envelope" class="w-4 h-4 absolute top-3 start-4" />
                ...
                <div class="grid grid-cols-1">
                  <div class="mb-5">
                    <div class="text-start">
                      ...
                      <div class="form-icon relative mt-2">
                        <Icon name="ph:chat-circle-text" class="w-4 h-4 absolute top-3 start-4" />
      ...
      <div class="flex justify-center gap-10">
        <a class="w-9 h-9 bg-color-2 rounded-full text-white flex justify-center items-center md:w-[70px] md:h-[70px]"
          ...
          <Icon :name="item.icon" v-bind="{ weight: 'regular' }" class="md:text-2xl" />
