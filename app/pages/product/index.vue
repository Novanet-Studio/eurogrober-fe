      ...
      <div class="container relative">
        <div class="grid grid-cols-1 mb-12">
          <div class="text-center md:text-start">
            <h1
              class="font-extrabold text-color-1 mb-2 text-xl md:text-3xl lg:text-5xl lg:leading-normal"
            >
              Products
            </h1>
            <p
    ...
    >
      <div class="container mt-8 md:px-0 md:mt-0">
        <div class="grid grid-cols-2 gap-[2px] mb-16 md:grid-cols-1">
          <button
            class="text-xs p-4 !important text-center transition ease-in md:p-4 lg:text-sm"
            :class="
      ...
      <div
        class="grid sm:grid-cols-2 grid-cols-1 mx-8 mt-8 gap-[30px] md:mx-0 md:grid-cols-2 lg:grid-cols-3"
        v-if="isLoading"
      >
        <div
      ...
      <div
        class="grid sm:grid-cols-2 grid-cols-1 mx-8 mt-8 md:mx-0 gap-[30px] md:mt-0 md:grid-cols-2 lg:grid-cols-3"
        v-else
      >
        <NuxtLink
          :id="category.slug"
