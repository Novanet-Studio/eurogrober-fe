    ...
    <ClientOnly v-else>
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div class="flex gap-4 h-[500px]">
          <div
            class="w-24 h-full shrink-0 relative flex flex-col items-center justify-center"
          >
            <button
            ...
            <swiper-container
              ...
              class="h-full w-full mySwiperThumbs"
            >
              <swiper-slide
          ...
          <div
            class="flex-1 h-full bg-white rounded-xl shadow-sm border border-gray-100 relative overflow-hidden"
          >
            <div
              class="absolute top-4 left-0 z-20 bg-red-600 text-white px-6 py-2 rounded-r-full font-bold shadow-md"
            >
              {{ product.name }}
            </div>
        ...
        <div class="flex flex-col">
          ...
          <div
            class="prose prose-lg max-w-none text-gray-600 h-[500px] overflow-y-auto pr-2 custom-scrollbar"
          >
